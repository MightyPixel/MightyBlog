...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_post', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 26, 0, 0), null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'date_modefied': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
