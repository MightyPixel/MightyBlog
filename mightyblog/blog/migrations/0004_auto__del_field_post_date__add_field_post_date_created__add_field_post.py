...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.date_modefied'
        db.add_column(u'blog_post', 'date_modefied',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 26, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.date_modefied'
        db.delete_column(u'blog_post', 'date_modefied')
        ...
        # Changing field 'Comment.author'
        db.alter_column(u'blog_comment', 'author', self.gf('django.db.models.fields.TextField')(max_length=63, null=True))
